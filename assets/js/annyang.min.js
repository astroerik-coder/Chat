  ...
  var a,
    ...
    R = function (e, n, t) {
      s.push({ command: e, callback: n, originalPhrase: t }),
        d && k("Comando cargado con éxito: %c" + t, p);
    },
    P = function (e) {
      var n;
      S(u.result, e);
      for (var t = 0; t < e.length; t++) {
        (n = e[t].trim()), d && k("Discurso reconocido: %c" + n, p);
    ...
    init: function (e) {
      ...
      a && a.abort && a.abort(),
        ...
        (a.onend = function () {
          if (((m = !1), S(u.end), c)) {
            ...
            (l += 1) % 10 == 0 &&
              d &&
              k(
                "El reconocimiento de voz se detiene y se inicia repetidamente. See http://is.gd/annyang_restarts para consejos."
              ),
              e < 1e3
                ? setTimeout(function () {
                    t.start({ paused: g });
        ...
        (a.onresult = function (e) {
          if (g) return d && k("Se escuchó el discurso, pero annyang está en pausa"), !1;
          for (
        ...
        if (e.hasOwnProperty(o))
          if ("function" == typeof (n = r[e[o]] || e[o]))
            ...
            if (
              ...
              d && k("No se puede registrar el comando: %c" + o, p);
              continue;
            }
    ...
    trigger: function (e) {
      t.isListening()
        ...
        : d &&
          k(
            m
              ? "Se escuchó el discurso, pero annyang está en pausa"
              : "No se puede disparar mientras se cancela annyang"
          );
    },
  });
});
